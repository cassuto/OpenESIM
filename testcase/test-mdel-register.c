...
main( int argc, char *argv[] )
{
  int rc;
  float error = 1e-6;
  if ( ds_test_init( "test-mdel-register" ) ) return 1;
  ...
  ds_test_check( circ_element_config(( R2, ELM_CONFIG_SET, /*r*/0, 100.0f ) ), "circ_element_config()" );
