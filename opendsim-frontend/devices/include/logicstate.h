...
#ifndef DEVICE_LOGICSTATE_H_
#define DEVICE_LOGICSTATE_H_

#include "device-lib-internal.h"

class dev_logicstate : public IDevice
{
public:
  dev_logicstate( const char *reference, int id, void *reserved );
