...
#ifndef DEVICE_VSOURCE_DC_ZERO_H_
#define DEVICE_VSOURCE_DC_ZERO_H_

#include "device-lib-internal.h"

class dev_vsource_dc_zero : public IDevice
{
public:
  dev_vsource_dc_zero( const char *reference, int id, void *reserved );
