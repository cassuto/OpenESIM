...
dsim_descriptor_t dsim_buff =
  {
    .pfn_create = buff_create,          /* callback function to create parameters */
    ...
    .pfn_uninit = buff_uninit           /* callback function to terminate the parameters */
  };

circ_element_descriptor_t mdel_buff =
  {
    .param_size = sizeof(buff_param_t),

    .symbol_name = "BUFF",              /* symbol name used to identify this element */

    .pin_count = 2,                     /* alterable, the number of pins of device */

    .mdel_type = MDEL_DIGITAL,          /* the electrical type of this model */

    .mdel = &dsim_buff                  /* pointer to the model descriptor structure */
  };
