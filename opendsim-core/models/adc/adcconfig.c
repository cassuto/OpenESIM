...
int
LIB_FUNC(adc_config)( circ_element_t *element, int op, ... )
{
        ...
        static model_variable_prop_t prop_list[] =
            {
              ...
              { "imp", "Input Impedance", MDEL_VAR_DOUBLE },
    ...
    case ELM_CONFIG_GET: /* Query the value of parameter */
      {
        ...
        switch ( param_id )
        {
          ...
          case 1: *(va_arg( vlist, double* )) = param->input_vh; break;
          case 2: *(va_arg( vlist, double* )) = param->input_vl; break;
    ...
    case ELM_CONFIG_SET: /* Set the value of parameter and make it effective */
      {
        ...
        switch ( param_id )
        {
          ...
          case 1: /* Logic Volt high */
            {
              param->input_vh = va_arg( vlist, double );
              break;
            }
          case 2: /* Logic Volt low */
            {
              param->input_vl = va_arg( vlist, double );
              break;
            }
          case 3: /* Input Impedance */
            {
              param->imp = va_arg( vlist, double );
              rc = adc_stamp( element );
              break;
            }
          case 4: /* Input Inverted */
            {
              int pin_index = va_arg( vlist, int );
