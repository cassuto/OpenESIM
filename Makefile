...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/configure $(top_srcdir)/testcase/Makefile.in \
...
CONFIG_CLEAN_FILES = testcase/Makefile
SOURCES =
DIST_SOURCES =
...
SUBDIRS = opendsim-core opendsim-frontend
all: config.h
...
testcase/Makefile: $(top_builddir)/config.status $(top_srcdir)/testcase/Makefile.in
