...
{
public:
  ComponentGraphItem( int id, IDevice *device, SchemaGraph *schgraph, QGraphicsItem *parent = 0 );
  ~ComponentGraphItem();

public:
  inline IDevice *device() { return m_device; }
  inline IDeviceGraph *deviceGraph() { return m_deviceGraph; }
